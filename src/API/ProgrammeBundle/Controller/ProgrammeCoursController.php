...
class ProgrammeCoursController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('APIProgrammeBundle:programmecours:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('APIProgrammeBundle:programmecours:new.html.twig', array(
            //APIInscriptionBundle:inscription:inscription.html.twig
...
*/
    ...
    public function showAction(ProgrammeCours $programmeCour, Request $request)
    {
        ...
        return $this->render('API/ProgrammeBundle/Resources/views/programmecours/show.html.twig', array(
            'programmeCour' => $programmeCour,
            'id_etablissement' => $idEtablissement,
    ...
    public function editAction(Request $request, ProgrammeCours $programmeCour)
    {
        ...
        return $this->render('API/ProgrammeBundle/Resources/views/programmecours/edit.html.twig', array(
            'programmeCour' => $programmeCour,
            'idEtablissement' => $idEtablissement,
