$(function(){
	...
	$.get("/app_dev.php/find",function(data) {
		render(data);
		var response = data,
				currentPath = '';
				//breadcrumbsUrls = [];
		...
		// This event listener changes on the URL. We use it to
	...
	function render(data) {
		...
		if(scannedFiles.length) {
			...
			scannedFiles.forEach(function(f) {
				...
				var file = $('<li class="files"><a href="'+ f.path+'" title="'+ f.name +'" class="files">'+icon+'<span class="name">'+ name +'</span> <span class="details">'+fileSize+'</span></a></li>');
