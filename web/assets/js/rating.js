(function(a){
    a.fn.rating=function(b){
        b=b||function(){};this.each(function(d,c){
            a(c).data("rating",{callback:b})
    ...
    a.extend(a.fn.rating,{init:function(h){
        ...
        d.append('<div class="stars">'+g+"</div>")
            .trigger("set.rating",j);a("a",d)
            .bind("click",a.fn.rating.click);
        ...
        hover:function(d){
            ...
            b.bind("mouseenter",function(f){
                a(this).addClass("tmp_fs").prevAll().
                addClass("tmp_fs");
